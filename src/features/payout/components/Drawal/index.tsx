...
export const Drawal = ({ isOpen, closeDrawal, data, isMutating }) => {
  ...
  let confirmDescription =""
    ...
    const { trigger: makeRequest } = useSWRMutationHook(
      requestPath,
      "PUT",
          ...
          <>
            ...
            <Card className="mb-5 ">
              ...
              <ul className="list-disc pl-6">
                {data?.withdraw?.bank ? (
                  <li className="mb-[6px]">open your bank app to ensure payment deleviery</li>
                ) : (
                  <>
                    <li className="mb-[6px]">
            ...
            <Card className="p-[4px] flex justify-center ease-linear	">
              <Button  onClick={openModalRequestModal} className=" bg-transparent text-black text-xl hover:bg-transparent hover:text-blue-light font-[500] text-[17px] text-center	">
                {ButtonTitle}
              </Button>
            </Card>
          </>
